...
1) when starting point is (2,0), the converaged point is (1.0000256,-0.9999341) which is local maximum point since the Hessian matrix at that point is negative definite.

2) when starting point is (-1,-2), the converaged point is (1.166791e-11,1.000000e+00) which is saddle point since the Hessian matrix at that point is neither positive or negative definite.

3) when starting point is (0,1), the converaged point is (0,1) which is saddle point since the Hessian matrix at that point is neither positive or negative definite.

4) when starting point is (1,-1), the converaged point is (1,-1) which is local maximum since the Hessian matrix at that point is negative definite.
